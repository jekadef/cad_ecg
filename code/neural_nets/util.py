...
def enumerate_estimated(
    ...
    """
    In terms of behavior, `enumerate_estimated` is almost identical
...
class LRScheduler():
    ...
    given number of `patience` epochs, then the learning rate will decrease
    by given `factor`.
    """
    def __init__(self, optimizer, patience=5, min_lr=1e-6, factor=0.3):
        """
